...
public class AvarageOfNum {
    public static class GlobalNumberAverageMapper extends Mapper < Object, Text, Text, DoubleWritable > {
        int sum = 0;
        int count = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(AvarageOfNum.class);
